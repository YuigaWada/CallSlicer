...
@class CXProvider; @class SBDashBoardViewController; @class TLAlertConfiguration; @class SpringBoard; @class BBServer; @class BBSound; @class BBBulletin; @class BBAction; @class AppDelegate; 
...
static __attribute__((constructor)) void _logosLocalCtor_060ad924(int __unused argc, char __unused **argv, char __unused **envp)
{
