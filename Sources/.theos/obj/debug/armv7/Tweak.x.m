...
@class AppDelegate; @class TLAlertConfiguration; @class SBDashBoardViewController; @class CXProvider; @class BBAction; @class BBSound; @class SpringBoard; @class BBBulletin; @class BBServer; @class SBMediaController; 
...
static __attribute__((constructor)) void _logosLocalCtor_6da9003b(int __unused argc, char __unused **argv, char __unused **envp)
{
